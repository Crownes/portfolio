...
//
// - Окружение УТ 11.5
// - Когда мастером данных для номенклатуры являлся сайт, а не 1С
// - 2 карточки SKU могли являться одним и тем же товаром физически
// - Но выбор карточки SKU зависил от выбора способа эксплуатации товара клиентом
// - Задача: при возникновении потребности по таким товарам, создавать пересортицу
// - Создан доп реквизит для SKU cо значением идентификатора связанного SKU
////////////////////////////////////////////////////////////////////////////////
